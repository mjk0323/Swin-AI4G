...
box_types = {
	"CLEAR":{
		"symbol":'.', 
		"cost":{"CLEAR":1, "MUD":2, "WATER":5, "MOUNTAIN":4, "GRAVELROAD":3}, 
		"colour":"WHITE"},
	"MUD":{
		"symbol":'m', 
		"cost":{"CLEAR":2, "MUD":4,"WATER":9, "MOUNTAIN":6, "GRAVELROAD":5}, 
		"colour":"BROWN"},
	"WATER":{
		"symbol":'~', 
		"cost":{"CLEAR":5, "MUD":9,"WATER":10, "MOUNTAIN":9, "GRAVELROAD":8}, 
		"colour":"AQUA"},
	"MOUNTAIN":{
		"symbol":'^',
		"cost":{"CLEAR":4, "MUD":6, "WATER":9, "MOUNTAIN":8, "GRAVELROAD":7},
		"colour":"GREEN"
	},
	"GRAVELROAD":{
		"symbol":'o',
		"cost":{"CLEAR":3, "MUD":5, "WATER":8, "MOUNTAIN":7, "GRAVELROAD":6},
		"colour":"BLACK"
	},
	"WALL":{
		"symbol":'X', 
...
agent_types = {
	"WALKER": {
		...
		"preferred_terrain": {
			"CLEAR":{
				"symbol":'.', 
				"cost":{"CLEAR":1, "MUD":3, "WATER":6, "MOUNTAIN":5, "GRAVELROAD":4}, 
				"colour":"WHITE"},
			"MUD":{
				"symbol":'m', 
				"cost":{"CLEAR":4, "MUD":6,"WATER":9, "MOUNTAIN":8, "GRAVELROAD":7}, 
			...
			"WATER":{
				"symbol":'~', 
				"cost":{"CLEAR":7, "MUD":9,"WATER":12, "MOUNTAIN":11, "GRAVELROAD":10}, 
				"colour":"AQUA"},
			"MOUNTAIN":{
				"symbol":'^',
				"cost":{"CLEAR":6, "MUD":8, "WATER":11, "MOUNTAIN":10, "GRAVELROAD":9},
				"colour":"GREEN"
			},
			"GRAVELROAD":{
				"symbol":'o',
				"cost":{"CLEAR":5, "MUD":7, "WATER":10, "MOUNTAIN":9, "GRAVELROAD":8},
				"colour":"BLACK"
			},
			"WALL":{
				"symbol":'X', 
	...
	"SWIMMER": {
		...
		"preferred_terrain": {
			"CLEAR":{
				"symbol":'.', 
				"cost":{"CLEAR":2, "MUD":3, "WATER":1, "MOUNTAIN":5, "GRAVELROAD":4}, 
				"colour":"WHITE"},
			"MUD":{
				"symbol":'m', 
				"cost":{"CLEAR":3, "MUD":5,"WATER":4, "MOUNTAIN":8, "GRAVELROAD":7}, 
				"colour":"BROWN"},
			"WATER":{
				"symbol":'~', 
				"cost":{"CLEAR":4, "MUD":5,"WATER":2, "MOUNTAIN":7, "GRAVELROAD":6}, 
				"colour":"AQUA"},
			"MOUNTAIN":{
				"symbol":'^',
				"cost":{"CLEAR":7, "MUD":8, "WATER":6, "MOUNTAIN":10, "GRAVELROAD":9},
				"colour":"GREEN"
			},
			"GRAVELROAD":{
				"symbol":'o',
				"cost":{"CLEAR":6, "MUD":7, "WATER":5, "MOUNTAIN":9, "GRAVELROAD":8},
				"colour":"BLACK"
			},
			"WALL":{
				"symbol":'X', 
	...
	"HIKER": {
		...
		"preferred_terrain": {
			"CLEAR":{
				"symbol":'.', 
				"cost":{"CLEAR":2, "MUD":3, "WATER":5, "MOUNTAIN":1, "GRAVELROAD":4}, 
				"colour":"WHITE"},
			"MUD":{
				"symbol":'m', 
				"cost":{"CLEAR":5, "MUD":6,"WATER":8, "MOUNTAIN":4, "GRAVELROAD":7}, 
				"colour":"BROWN"},
			"WATER":{
				"symbol":'~', 
				"cost":{"CLEAR":7, "MUD":8,"WATER":10, "MOUNTAIN":6, "GRAVELROAD":9}, 
				"colour":"AQUA"},
			"MOUNTAIN":{
				"symbol":'^',
				"cost":{"CLEAR":3, "MUD":4, "WATER":6, "MOUNTAIN":2, "GRAVELROAD":5},
				"colour":"GREEN"
			},
			"GRAVELROAD":{
				"symbol":'o',
				"cost":{"CLEAR":6, "MUD":7, "WATER":9, "MOUNTAIN":5, "GRAVELROAD":8},
				"colour":"BLACK"
			},
			"WALL":{
				"symbol":'X', 
	...
	"CLIMBER": {
		"preferred": "GRAVELROAD",
		"preferred_terrain": {
			"CLEAR":{
				"symbol":'.', 
				"cost":{"CLEAR":2, "MUD":3, "WATER":6, "MOUNTAIN":5, "GRAVELROAD":1}, 
				"colour":"WHITE"},
			"MUD":{
				"symbol":'m', 
				"cost":{"CLEAR":5, "MUD":6,"WATER":9, "MOUNTAIN":8, "GRAVELROAD":4}, 
				"colour":"BROWN"},
			"WATER":{
				"symbol":'~', 
				"cost":{"CLEAR":8, "MUD":9,"WATER":12, "MOUNTAIN":11, "GRAVELROAD":7}, 
				"colour":"AQUA"},
			"MOUNTAIN":{
				"symbol":'^',
				"cost":{"CLEAR":7, "MUD":8, "WATER":11, "MOUNTAIN":10, "GRAVELROAD":6},
				"colour":"GREEN"
			},
			"GRAVELROAD":{
				"symbol":'o',
				"cost":{"CLEAR":3, "MUD":4, "WATER":7, "MOUNTAIN":6, "GRAVELROAD":2},
				"colour":"BLACK"
			},
			"WALL":{
				"symbol":'X', 
...
class Box(object):
	...
	def __init__(self,index, x, y, width, height, type='.'):
		...
		self.box = pyglet.shapes.Triangle(
...
class BoxWorld(object):
	...
	def _add_edge(self, from_idx, to_idx, distance=1.0):
		b = self.boxes
		from_type = b[from_idx].type
		to_type = b[to_idx].type

		agent_terrain = agent_types[self.agent]["preferred_terrain"]

		if "cost" in agent_terrain.get(from_type, {}) and to_type in agent_terrain[from_type]["cost"]:
			cost = agent_terrain[from_type]["cost"][to_type]
